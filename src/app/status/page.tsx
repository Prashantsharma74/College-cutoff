...
function StatusPage() {
  ...
  return (
    <>
      <Seo
        title="Application Status - Track Admission Progress"
        description="Track your application status, counselling progress, and admission updates in real time."
        keywords="application status check, counselling status tracking, admission progress"
      />
      <div className="p-4">
