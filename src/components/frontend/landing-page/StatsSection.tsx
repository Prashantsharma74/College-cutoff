...
//     { icon: <Users />, value: "30K+", label: "Students Guided" },
//     { icon: <Building />, value: "500+", label: "Colleges Covered" },
//     { icon: <BookMarked />, value: "25K+", label: "Queries Solved" },
//   ]
...
//       {/* 🔵 Glow */}
//       <div className="absolute top-[-80px] left-[-80px] w-64 h-64 bg-blue-400 opacity-20 blur-3xl rounded-full"></div>
//       <div className="absolute bottom-[-80px] right-[-80px] w-64 h-64 bg-orange-400 opacity-20 blur-3xl rounded-full"></div>
...
//             Our Impact in Numbers
//           </h2>
//           <p className="text-gray-600 mt-3 mb-14">
...
//               <div
//                 key={i}
//                 className="group bg-white border border-gray-200 rounded-2xl p-6 text-center shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
//               >
